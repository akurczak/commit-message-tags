...
internal class TaggersTabbedView(project: Project) {
    ...
    private val services = commitTagServicesById(project)

    private val settingsPanels = services.mapValues { it.value.createSettingsPanel().withBorder(EmptyBorder(20, 20, 20, 20)) }
